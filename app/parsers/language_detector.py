...
COMMON_WORDS: dict[str, set[str]] = {
    "en": {
        ...
        "say", "she", "too", "use", "about", "after", "again", "being", "below",
        "could", "every", "first", "found", "great", "house", "large", "learn",
        "never", "other", "place", "plant", "point", "right", "small", "sound",
        "spell", "still", "study", "their", "there", "these", "thing", "think",
        "three", "water", "where", "which", "world", "would", "write",
    },
    "es": {
        "el", "la", "de", "en", "que", "los", "del", "las", "por", "con",
        "una", "para", "como", "más", "pero", "sus", "le", "ya", "o", "este",
        "ha", "sí", "porque", "esta", "son", "entre", "cuando", "muy", "sin",
    ...
    "fr": {
        "le", "la", "de", "et", "les", "des", "un", "une", "du", "en",
        "que", "qui", "dans", "est", "pas", "pour", "sur", "sont", "avec",
        "plus", "par", "son", "mais", "tout", "comme", "nous", "vous", "ils",
        "elle", "ont", "fait", "peut", "bien", "aussi", "cette", "être",
        "avoir", "mon", "leur", "ces", "mes", "tes", "nos", "vos", "aux",
    },
    "de": {
    ...
    "pt": {
        ...
        "se", "na", "por", "mais", "dos", "como", "mas", "foi", "ao", "ele",
        "das", "tem", "à", "seu", "sua", "ou", "ser", "quando", "muito",
        "há", "nos", "já", "está", "eu", "também", "só", "pelo", "pela",
    },
    "hi": {
        "के", "में", "है", "की", "एक", "और", "को", "यह", "पर", "से",
        "इस", "था", "ने", "कि", "वह", "क्या", "तो", "हैं", "या", "अब",
    },
    "ar": {
        "في", "من", "على", "هذا", "التي", "الذي", "إلى", "عن", "كان",
    },
    "ja": {
        "の", "に", "は", "を", "た", "が", "で", "て", "と", "し",
    },
